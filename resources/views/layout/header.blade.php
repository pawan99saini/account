					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
							...
							<a href="{{url('dashboard')}}" class="d-lg-none">
								...
								<img alt="Logo" src="{{asset('demo1/media/logos/logo.png')}}" class="h-30px" />
							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
									...
									<div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										...
										<img src="{{asset('demo1/media/avatars/profile.png')}}" alt="user" />
										...
										<div class="menu-item px-3">
											...
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="symbol symbol-50px me-5">
													...
													<img alt="Logo" src="{{asset('demo1/media/avatars/profile.png')}}" />
