      ...
      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
			...
			<span valign="top" style=" font-size:24px; color:#000000; font-weight:800; font-family: 'Muli', sans-serif;">{{$invoice->billing->company_name}}</span></br>
			@if($invoice->billing->gstin) GSTIN:@endif {{$invoice->billing->gstin}}</br>
			@if($invoice->billing->pan) PAN:@endif {{$invoice->billing->pan}}</br>
			@if($invoice->billing->website) Website:@endif {{$invoice->billing->website}}</br>
			</td>
			<td style="font-family: 'Muli', sans-serif;">{{$invoice->billing->company_name}}</br>
            ...
            <td><table style="border:1px solid #999999;" width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody>
                <tr>
                  ...
                  <td width="15%" style="border-right:1px solid #999999;"><span style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">{{$invoice->invoice_date}}</span></td>
                </tr>
                <tr>
                  ...
                  <td style="border-right:1px solid #999999;"><span style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">{!! $invoice->party->address!!}, {{$invoice->address_1}}, </span></td>
                                        ...
                                        <table style="border:1px solid #999999;" width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="20%"><span style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">{{$invoice->invoice_date}}</span></td>
                                                </tr>
                                                <tr>
                                                    <td height="25"><strong><span style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">Address</span></strong></td>
                                                    <td><span style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">{!! $invoice->party->address!!}, {{$invoice->address_1}},</span></td>
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb2">
                                            <tbody>
                                                @if($invoice->remarks)<tr style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">
                                                    <td width="15%" height="50" align="left">Remarks :  </td>
