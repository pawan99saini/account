...
<table style="border:1px solid #999999;" width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
  ...
  <tbody>
      ...
      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          ...
          <tr>
			...
			<td rowspan="2" >@if($invoice->billing->logo)<img src="{{asset('storage/uploads/'.$invoice->billing->logo)}}" style="width:100px;margin:10px">@endif</td>

            </tr>

          <tr>

            <td style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;" >{{$invoice->billing->address_1}}</td>
          ...
          <tr>
            ...
            <td style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">{{$invoice->billing->address_2}}</td>

			<td style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">GSTIN : {{$invoice->billing->gstin}}</td>
          ...
          <tr>
			...
			<td style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">Pan No : {{$invoice->billing->pan}}</td>
          ...
          <tr>
			...
			<td style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">Email: {{$invoice->billing->email}}</td>

            </tr>

			<tr>

            <td style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">Contact: {{$invoice->billing->phone}}</td>

			<td style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">Website: {{$invoice->billing->website}}</td>
            ...
            <td><table style="border:1px solid #999999;" width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tbody>
				...
				<tr>
                  ...
                  <td><span style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">{{$invoice->party->cell_phone}} | {{$invoice->party->email}} </span></td>

                  <td height="25"><strong><span style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;">PAN No</span></strong></td>
          ...
          <tr>
            ...
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb2">
              ...
              <tbody>
                ...
                <tr style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif; vertical-align:text-top;">
    ...
    <tr>
      ...
      <td style=" font-size:13px; color:#000; padding:5px; font-family: 'Muli', sans-serif;" width="47%" align="right"><strong>For Billing Entity Company Name</strong></td>
