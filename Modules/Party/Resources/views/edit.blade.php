            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                <form class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                    ...
                                    id="kt_careers_form" action="{{ route('parties.update',$party->id) }}"
                ...
                <div class="col-md-12 fv-row fv-plugins-icon-container">
                    ...
                    <textarea class="form-control form-control-solid" placeholder=""
                        ...
                        name="address">{{ $party->address }}</textarea>
                    ...
                    <!--end::Input-->
                                ...
                                <textarea class="form-control form-control-solid" placeholder=""
                                    ...
                                    name="address_1">{{ $party->address_1 }}</textarea>
                                ...
                                <select name="country_id" class="form-control form-control-solid" onchange="GetState(this)" id="country_id">
                                    ...
                                    <option value="{{$country->id}}" {{$country->id==$party->country_id ? 'selected' : ''}}>{{$country->name}}</option>
                                    @endforeach
                                </select>
                                ...
                                <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                ...
                                                name="pincode" value="{{ $party->pincode }}">
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                ...
                                                name="cell_phone" value="{{ $party->cell_phone}}">
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                ...
                                                name="client_gst_number" value="{{ $party->client_gst_number}}">
                                        ...
                                        <!--begin::Input-->
                                            <select name="group_id" class="form-control form-control-solid" >
                                                ...
                                                <option value="{{$group->id}}" {{$group->id==$party->group_id ? 'selected' : ''}}>{{$group->name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <!--begin::Input-->
                                            <select name="partner_id" class="form-control form-control-solid" >
                                                ...
                                                <option value="{{$channel_partner->id}}" {{$channel_partner->id==$party->partner_id ? 'selected' : ''}}>{{$channel_partner->name}}</option>
                                                @endforeach
                                            </select>
                                ...
                                <label>
                                <input type="checkbox"  {{ $party->status==1 ? 'checked' : '' }} name="status">
                                <span></span>
                                </label>
                                </span>
                                </div>
...
<script>
    var state_id = "{{$party->state_id}}";
    var city_id = "{{$party->city_id}}";
</script>
@endsection
