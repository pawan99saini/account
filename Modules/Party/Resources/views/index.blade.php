           ...
           <input type="text" name="keyword" class="form-control" value="{{ !empty(Request::get('keyword')) ? Request::get('keyword') : '' }}">
            ...
            <div class="col-md-6 fv-row fv-plugins-icon-container">
                        ...
                        <button type="submit" id="kt_modal_new_target_submit" class="btn btn-primary mt-8">
                         ...
                         <a href="{{route('parties.index')}}" class="btn btn-primary mt-8">
                            <span class="indicator-label">
                                Reset
                            </span>
                                    ...
                                    @foreach($data as $val)
                                        <tr>
                                            ...
                                            <div class="d-flex flex-shrink-0">
																...
																<a href="{{ route('parties.edit', $val->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                                ...
                                                                <form action="{{ route('parties.destroy', $val->id) }}" method="POST" id="delete-{{$val->id}}">
  @csrf
  @method("DELETE")
