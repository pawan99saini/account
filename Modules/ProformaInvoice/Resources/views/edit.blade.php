        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                <form class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                    ...
                                    id="kt_careers_form" action="{{ route('invoice.update',$proformainvoice->id) }}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text"  class="form-control form-control-solid date" 
                                                ...
                                                name="invoice_date"  value="{{$proformainvoice->invoice_date}}" readonly>
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <option value="{{$bill->id}}" {{$proformainvoice->billing_id==$bill->id ? 'selected' : ''}}>{{$bill->company_name}}</option>
                                            @endforeach
                                            </select>
                                         ...
                                         <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <option value="{{$party->id}}" {{$proformainvoice->party_id==$party->id ? 'selected' : ''}}>{{$party->name}}</option>
                                            @endforeach
                                            </select>
          ...
          <input class="w-100px date1" name="invoice[{{$item->id}}][to]" placeholder="To date" value="{{$item->to}}"></div>
                                ...
                                <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <textarea  class="form-control form-control-solid" name="remarks" >{{$proformainvoice->remarks}}</textarea>
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="number"  min="0" class="form-control form-control-solid" 
                                                ...
                                                name="expense"  value="{{$proformainvoice->expense}}" >
...
<script>
    var bill_id = "{{$proformainvoice->billing_id}}" 
    var party = "{{$proformainvoice->party_id}}" 
</script>
@endsection
