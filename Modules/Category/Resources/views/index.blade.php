                                    ...
                                    @foreach($data as $val)
                                        <tr>
                                            ...
                                            <div class="d-flex flex-shrink-0">
																...
																<a href="{{ route('categories.edit', $val->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                                ...
                                                                <form action="{{ route('categories.destroy', $val->id) }}" method="POST" id="delete-{{$val->id}}">
  @csrf
  @method("DELETE")
