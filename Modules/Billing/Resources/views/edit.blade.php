        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Billing
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                <form class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                    ...
                                    id="kt_careers_form" action="{{ route('billing.update',$billing->id) }}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                ...
                                                name="company_name" value="{{ $billing->company_name }}">
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <textarea  class="form-control form-control-solid" placeholder=""
                                                ...
                                                name="address_1" >{{ $billing->address_1 }}</textarea>
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <textarea  class="form-control form-control-solid" placeholder=""
                                                ...
                                                name="address_2" >{{ $billing->address_2 }}</textarea>
                                        ...
                                        <!--begin::Input-->
                                            <select name="country_id" class="form-control form-control-solid" onchange="GetState(this)" id="country_id">
                                                ...
                                                <option value="{{$country->id}}" {{$country->id==$billing->country_id ? 'selected' : ''}}>{{$country->name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                ...
                                                name="pincode" value="{{ $billing->pincode }}">
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                ...
                                                name="website" value="{{ $billing->website }}">
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                ...
                                                name="gstin" value="{{ $billing->gstin }}">
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                            @if($billing->logo)
                                            <img src="{{asset('storage/uploads/'.$billing->logo)}}">
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--begin::Input-->
                                                ...
                                                <textarea class="form-control form-control-solid" placeholder="" name="bank_details">{{ $billing->bank_details  }}</textarea>
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--begin::Input-->
                                                ...
                                                name="note">{{ $billing->note  }}</textarea>
                                         ...
                                         <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                     ...
                                                     value="{{$billing->invoice_number}}" disabled>
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <textarea  class="form-control form-control-solid ckeditor" placeholder=""
                                                ...
                                                name="pi_notes" >{{$billing->pi_notes }}</textarea>
                                ...
                                <label>
                                <input type="checkbox"  {{ $billing->status==1 ? 'checked' : '' }} name="status">
                                <span></span>
                                </label>
                                </span>
                                </div>
...
<script>
    var state_id = "{{$billing->state_id}}";
    var city_id = "{{$billing->city_id}}";
</script>
@endsection
