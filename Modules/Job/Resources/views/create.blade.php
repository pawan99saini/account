                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                <form class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                    ...
                                    id="kt_careers_form" action="{{ route('job.store') }}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <label class="required fs-5 fw-semibold mb-2">Csv</label>
...
<input type="text" class="form-control form-control-solid" value="{{old('name')}}" placeholder="" name="name" >
@if($errors->has('name'))
