...
class InvoiceExport implements FromCollection, WithHeadings
{
    ...
    */
    ...
    {
        $invoices = Invoice::with('billing','party')->select("id","invoice_number", "invoice_date","billing_id","party_id","subtotal","total_cgst","total_sgst","total","remarks","expense","status")->where($this->where)->get();
